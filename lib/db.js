...
var DB_URL = process.env.MONGOHQ_URL || 'mongodb://localhost:27017/masalanpelto';
...
exports.saveFile = function (doc, userfile) {
    ...
    function onStatusUpdateFail(fileId, newStatus, err) {
        console.error('could not change file ' + fileId +
    ...
    function onUploadSuccess() {
        ...
        file.save(function (err) {
            ...
            console.log('changed file ' + file._id + ' status to ' + status);
        });
    }

    function onUploadFail(err) {
        console.error('file ' + file._id + ' upload failed: ' + err);
