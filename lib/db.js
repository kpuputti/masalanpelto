...
exports.S3_ROOT = 'https://s3.amazonaws.com/' + process.env.S3_BUCKET_NAME + '/';
...
exports.getFile = function (filename) {
    var deferred = Q.defer();
    s3.get(filename).on('response', function (res) {
        console.log('got res from S3' + res.statusCode, res.headers);
